...
public interface Repository<ID, ENTITY> {
     ...
     * @return identifier of the entry, null if entry has not been saved
     */
     ...
     * @return entity with specified identifier or null if the repository does not contain such entity
     */
    ENTITY query(ID id);
     ...
     * @return updated entity with specified identifier or null if the repository does not contain such entity
     */
     ...
     *
     * @param id identifier whose associated entity is to be updated
     * @return true if the repository contained entity with the specified identifier
     */
